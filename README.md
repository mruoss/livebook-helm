...
| `livebook.image.tag`                        | Livebook image tag (immutable tags are recommended)                                                      | `0.13.3`                |
...
| `livebook.volumePermissions.image.tag`                               | Init container volume-permissions image tag (immutable tags are recommended)                                                                                                                                                                          | `12-debian-12-r28`         |
